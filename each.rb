...
weather_options.each do |weather|                     # will run each iteration in the array above
    puts "The weather is " + weather + " today"       # space after "is" and before "today" to ensure proper spacing in print out
end
